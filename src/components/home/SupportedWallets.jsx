  ...
  return (
      <div className='lg:py-20 md:py-14 sm:py-10 py-6 relative'>
          ...
          <div className='container'>
              ...
              <p className='font-normal pp-telegraf-normal text-base leading-custom-xl text-center max-w-[504px] mx-auto pt-3 text-white opacity-80'>Lorem ipsum dolor sit amet consectetur. Eu bibendum in mollis vitae
              ...
              <div className='lg:flex-row flex-wrap flex gap-5 justify-center lg:mt-[60px] sm:mt-10 mt-6'>
                  {WALLET_DATA.map((wallet, index) => (
                      ...
                      >
                          ...
                          <p className='text-white text-2xl pp-telegraf-bold font-extrabold text-center pt-5'>{wallet.name}</p>
                      </div>
                  ))}
              </div>
          </div>
