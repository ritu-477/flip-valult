...
const ConnectWallets = () => {
  return (
    <div className='lg:pt-16 sm:pt-12 pt-6 relative'>
      <img className='left-0 absolute -z-10 max-w-[600px] pointer-events-none w-full' src={connectEllipse} alt="connect-ellipse" />
