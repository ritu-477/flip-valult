...
const HeroHome = () => {
  return (
      <div className='lg:pt-[161px] md:pt-[120px] sm:pt-[80px] pt-12 pb-9 md:pb-[51px]'>
          <div className='container'>
              ...
              <div className='md:py-5 md:px-8 py-4 px-5 rounded-[20px] border border-gray-border bg-ink-black bg-opacity-50 backdrop-blur-[33.5px] max-w-[795px] w-full mx-auto mt-7 sm:mt-[51px]'> 
