            ...
            <div className='container'>
                <div className='max-w-[1160px] w-full lg:py-[90px] md:py-16 sm:py-12 py-5 px-5 rounded-[30px] bg-no-repeat bg-ink-black bg-[100%,100%] relative bg-center lg:bg-ready z-10'>
                    <div className='absolute top-0 left-0'>
                        <img className='lg:max-w-[107px] md:max-w-[80px] sm:max-w-[60px] max-w-[40px] circle-one overflow-hidden' src={circleOne} alt="circle-one" />
                    </div>
                    <div className='absolute top-0 right-[30%]'>
                        <img className='md:max-w-[80px] sm:max-w-[50px] max-w-[30px] circle-two overflow-hidden' src={circleTwo} alt="circle-one" />
                    </div>
                    ...
                    <div className='absolute top-[5%] right-[5%]'>
                        <img className='lg:max-w-[250px] md:max-w-[220px] sm:max-w-[180px] max-w-[80px] circle-four overflow-hidden' src={circleFour} alt="circle-one" />
                    </div>
                    <div className='flex flex-col items-center'>
                        ...
                        <button className='bg-gradient-to-r from-[#6494EE] relative z-10 to-[#085BF7] text-white font-extrabold text-base rounded-[10px] sm:mt-6 mt-4 lg:mt-[30px] text-center sm:py-[14.5px] sm:px-[47px] py-3 px-8'>Join Now</button>
                    </div>
                </div>
            </div>
        </div>
